...
public class strLesson {
    public static void main(String[] args) {
        ...
        String stri = "Здра";
        "Здравствуй".equals(stri + "вствуй");

        String s12 = "Привет";
        String s22 = "ПРИВЕТ";
        String s333 = s1.toUpperCase();

        System.out.println(s12.equalsIgnoreCase(s22));
        System.out.println(s12.equalsIgnoreCase(s333));
        System.out.println(s22.equalsIgnoreCase(s333));
    }
}
